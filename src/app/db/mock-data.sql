...
VALUES
  ('School Supplies', 40.00, 'CS 246 Textbook', 'Used for one term, some highlights', 'gently used', 1, 'UWaterloo SLC', 'uid_alice', 'for sale', 'images/cs246.jpg'),
  ...
  ('Electronics', 100.00, 'Bluetooth Speaker', 'Bass heavy, battery still good', 'fair', 1, 'UWaterloo Dana Porter Library', 'uid_alice', 'sold', 'images/speaker.jpg');
